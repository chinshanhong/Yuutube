...
public class videoOptions{
    ...
    public static void userVideoOperations(int[] videoIdList)throws IOException{
          boolean status = true;
          ...
          while(status){
              ...
              switch(user_choice){
                  case 1:
                      videoMenu.mainMenu(videoIdList[user_choice-1]);
                      status = false;
                      break;
